						...
						<form action="login-process.php" method="post" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-sm-4 text-right">
									<button type="submit" name="save" value="signin" class="btn btn-primary hidden-xs">Sign In</button>
									<button type="submit" name="save" value="signin" class="btn btn-primary btn-block btn-lg visible-xs mt-lg">Sign In</button>
								</div>
							</div>
